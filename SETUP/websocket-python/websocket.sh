...
Documentation=https://github.com/yolonet/
...
wget -q -O /usr/local/bin/ws-https https://${Server_URL}/SETUP/websocket-python/ws-https; chmod +x /usr/local/bin/ws-https

# // PYTHON WEBSOCKET DROPBEAR
wget -q -O /usr/local/bin/ws-http https://${Server_URL}/SETUP/websocket-python/ws-http; chmod +x /usr/local/bin/ws-http

# // PYTHON WEBSOCKET OVPN
wget -q -O /usr/local/bin/ws-ovpn https://${Server_URL}/SETUP/websocket-python/ws-ovpn; chmod +x /usr/local/bin/ws-ovpn
